...
uklad_rownan: obj/main.o obj/UkladRownanLiniowych.o obj/Macierz.o obj/Wektor.o obj/LZespolone.o
	g++ -Wall -pedantic -o uklad_rownan obj/main.o obj/Wektor.o\
                                   obj/Macierz.o obj/UkladRownanLiniowych.o obj/LZespolone.o
...
obj/LZespolone.o: src/LZespolone.cpp inc/LZespolone.hh 
	g++ ${CPPFLAGS} -o obj/LZespolone.o src/LZespolone.cpp
